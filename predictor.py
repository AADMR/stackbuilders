...
class Road:
    def __init__(self,name):#Constructor
        ...
        self.law_plate=["1-2","3-4","5-6","7-8","9-0"]# pos 0 = Monday, 1=Tuesday, 2=Wednesday...
    ...
    def predictor(self):#Method # 2 (This method doesn't check if the data inputs are correct because the methond "input_detection" does it.)
        ...
        for a in range (0,len(self.law_time)):# It depends on format "7:00-9:30"
        ...
        if (sts_1==0 or sts_2==0 or sts_3==0):
